...
export const SemesterCard:FC<Props> = ({ semester, stament, index }) => {
  ...
  return (
    ...
    style={tw`w-50 h-50 m-2 rounded-3xl bg-zinc-100 shadow-2xl dark:shadow-white  `}>
        <TouchableOpacity
        ...
        >
            ...
            <Text style={tw`text-[#6F6F6F] text-3xl  absolute bottom-5 right-5 font-bold`}>{semester.semestre}</Text>
        </TouchableOpacity>
    </MotiView>
  )
}
